...
//     directly.
public abstract class IslandComponentBase2<TResult> : IComponent, IHandleEvent, IHandleAfterRender, IReactiveComponent
{
    ...
    {
        this.data = await LoadPageDataAsync<TResult>(default(TResult));
        OnInitialized();
